...
columns = [
    ...
    { title: "入库日", data: "warehouseDate", orderable: true, searchable: true, name: "s.warehouseDate" },
    { title: "天数", data: "days", orderable: true, searchable: true, name: "s.warehouseDate", className: "alignRight" }
];
...
$(document).ready(function () {
    ...
    tableBox = initDataTables(
        ...
        columns,
        createdRow,
        constant.projectURL + STOCKCONTROLLER_NAME + '/searchOutofdateStock',
        getSearchConditon,
        1, 0,
        false,
        true,
...
function exportExcel() {
    //form添加action
    $("#myHeader form").attr("action", constant.projectURL + STOCKCONTROLLER_NAME + '/exportOutofdateStock');
